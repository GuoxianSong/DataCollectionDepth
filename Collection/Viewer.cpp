...
void SampleViewer::display()
{
		...
		m_eViewState == DISPLAY_MODE_IMAGE) && m_colorFrame.isValid())
	{
		...
		frame.create(m_colorFrame.getHeight(), m_colorFrame.getWidth(), CV_8UC3);
		memcpy(frame.data, pImageRow, 3 * m_colorFrame.getHeight()*m_colorFrame.getWidth()*sizeof(uint8_t));
